    ...
    <div className="max-w-5xl mx-auto">
      ...
      {tab === 0 && (
        <>
          ...
          <Card className="mt-4">
            <h3 className="font-semibold text-pandora-gold mb-2">Przełączanie umiejętności ciągłych</h3>
            <p className="text-sm text-pandora-muted">Umiejętności aktywne można włączać/wyłączać jak np. Ognisty Duch. Nie wyłączają się po przelogowaniu!</p>
          </Card>
        </>
      )}
      ...
      {tab === 1 && (
        <>
          ...
          <p className="text-pandora-muted mb-4">Pasywna umiejętność pozwalająca na nadanie ról członkom drużyny. Lider nie może wybrać roli dla siebie.</p>
      ...
      {tab === 2 && (
        <>
          ...
          <p className="text-pandora-muted mb-4">System przemiany w potwory — zwiększa obrażenia. Działanie analogiczne do serwera globalnego z ułatwieniami w zdobywaniu marmurów.</p>
          ...
          <Card>
            <p className="text-sm text-pandora-muted mb-2">U <strong>Uriela</strong> (każde M1) możesz wymienić:</p>
            <p className="text-sm"><strong>5x dowolny Marmur Polimorfii + 50M Yang</strong> → Marmur Dzikiego Sługi, Czarnego Orka lub Młodego Pająka</p>
          </Card>
