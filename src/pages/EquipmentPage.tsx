  ...
  return (
    <div className="max-w-5xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="bg-pandora-card border border-pandora-border rounded-xl p-5">
          <h3 className="font-semibold text-pandora-gold mb-2">Magiczny Metal+</h3>
          <p className="text-sm text-pandora-muted mb-3">Daje dodatkowe +10% szansy na ulepszenie przedmiotu.</p>
          <div className="space-y-2 text-sm">
            <p className="text-pandora-text">Wymagane materiały:</p>
            <div className="flex items-center gap-2">
              <div className="w-2 h-2 rounded-full bg-pandora-gold" />
              <span className="text-pandora-muted">Kamień Kowala</span>
            </div>
            <div className="flex items-center gap-2">
              <div className="w-2 h-2 rounded-full bg-pandora-gold" />
              <span className="text-pandora-muted">Magiczna Ruda Miedzi</span>
            </div>
            <div className="flex items-center gap-2">
              <div className="w-2 h-2 rounded-full bg-pandora-gold" />
              <span className="text-pandora-muted">100.000.000 Yang</span>
            </div>
          </div>
        </div>
        <div className="bg-pandora-card border border-pandora-border rounded-xl p-5">
          <h3 className="font-semibold text-pandora-gold mb-2">Bonus Switcher</h3>
          <p className="text-sm text-pandora-muted mb-3">System szybkiej zamiany bonusów w Menu Gracza.</p>
          <div className="space-y-2 text-sm text-pandora-muted">
