...
export default function RankSystemPage() {
  return (
    <div className="max-w-5xl mx-auto">
      ...
      <p className="text-pandora-muted mb-4">Alternatywny sposób zdobywania punktów rangi — z Bossów:</p>
      <DataTable
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <Card>
          <h3 className="font-semibold text-pandora-gold mb-2">Rycerz (20K pkt)</h3>
          <p className="text-sm text-pandora-muted">Osiągalny relatywnie szybko przez zwykły farm. Pierwszy bonus PvP.</p>
        </Card>
        <Card>
          <h3 className="font-semibold text-pandora-gold mb-2">Cesarz (10M pkt)</h3>
          <p className="text-sm text-pandora-muted">Najwyższa ranga. +2500 PŻ i +30% SPL. Wymaga ogromnej ilości farmu i Owoców Życia.</p>
        </Card>
      </div>
    </div>
  )
