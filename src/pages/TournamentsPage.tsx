...
const tournaments: Tournament[] = [
  ...
  /* ─── EDYCJA 8 ─── */
  {
    ...
    semifinalists: ['EsportowySen', 'Ohana'],
    matches: [
  ...
  /* ─── EDYCJA 6 ─── */
  {
    ...
    semifinalists: ['szmex', 'SixDays', 'NewFaces', 'SixDays'],
    matches: [
      ...
      { nr: 22, round: 'Półfinał (BO3)', teamA: 'szmex',  teamB: 'SixDays',      score: '2:0 (100:60, 100:67)', winner: 'szmex',    date: '23.03.2025 16:00' },
      { nr: 23, round: 'Półfinał (BO3)', teamA: 'NewFaces',teamB: 'SixDays',     score: '2:0 (100:80, 100:52)', winner: 'NewFaces', date: '23.03.2025 17:00' },
      { nr: 24, round: '🏆 FINAŁ (BO5)', teamA: 'szmex',  teamB: 'NewFaces',     score: '3:0 (100:72, 100:90, 100:91)', winner: 'szmex', date: '23.03.2025 18:00' },
    ],
  ...
  /* ─── EDYCJA 4 ─── */
  {
    ...
    server: 'OLD',
    format: 'Drabinka — informacje szczegółowe niedostępne',
    totalGuilds: 7,
    guilds: ['WrogRezimu', 'GloriaVictis', 'Kuciapki', 'SkillTEST', 'TimeToDie', 'ChaosTheory', 'EsportowySen'],
    winner: '—',
    finalist: '—',
    finalScore: '—',
    finalResult: 'Brak danych — wątek wynikowy usunięty',
    matches: [],
    forumUrl: 'https://forum.pandoramt2.pl/topic/8330-turniej-gildii/',
    status: 'no-results',
  } as Tournament,
  /* ─── EDYCJA 3 ─── */
  {
  ...
  /* ─── EDYCJA 2 ─── */
  {
    ...
    server: 'OLD',
    format: 'Bitwa otwarcia BO1 → Ćwierćfinały BO1 → Półfinały BO3 → Finał BO3',
    totalGuilds: 9,
    ...
    matches: [
      ...
      { nr: 8,  round: '🏆 FINAŁ (BO3)', teamA: 'OldBoys', teamB: 'LionKing',   score: '3:0 (100:86, 100:74, 100:86)', winner: 'OldBoys', date: '21.04.2024 18:00' },
    ],
