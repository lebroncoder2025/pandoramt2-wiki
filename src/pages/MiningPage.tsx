    ...
    <div className="max-w-5xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-7 mb-14">
        <Card className="border-t-2 border-t-pandora-blue/20">
          ...
          <p className="text-[13px] text-pandora-muted leading-relaxed">Startowy na +0. Zbieraj Punkty Kilofa podczas kopania. Na maks. punktach ulepsz u Deokbae. Max: <strong className="text-pandora-text/85">+9</strong>. Każdy lvl daje +3% do +30% efektywności.</p>
        </Card>
        <Card className="border-t-2 border-t-pandora-gold/20">
          ...
          <p className="text-[13px] text-pandora-muted leading-relaxed">Wszystkie żyły zamienione na Żyłę Złota. Wydobywasz <strong className="text-pandora-text/85">3-5 Sztabek Złota (5KK)</strong> z każdej.</p>
        </Card>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-7">
        <Card className="border-t-2 border-t-pandora-orange/20">
          ...
          <p className="text-[13px] text-pandora-muted leading-relaxed">Bonusowy drop podczas kopania. Szansa rośnie z każdym poziomem kilofa. Zawiera wartościowe przedmioty.</p>
        </Card>
        <Card className="border-t-2 border-t-pandora-purple/20">
          ...
          <p className="text-[13px] text-pandora-muted leading-relaxed">Losowy drop przy kopaniu. Wrzuć do <strong className="text-pandora-text/85">Ołtarza</strong> w swoim królestwie. Po zebraniu 1000 kryształów przez królestwo — <strong className="text-pandora-text/85">1h podwójny drop</strong> dla wszystkich!</p>
        </Card>
      </div>
    </div>
  )
